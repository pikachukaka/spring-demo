...
public class DefaultAdvisorProxyCreator implements InstantiationAwareBeanPostProcessor, BeanFactoryAware {
    private DefaultListableBeanFactory beanFactory;

    public DefaultAdvisorProxyCreator() {
    }

    public DefaultAdvisorProxyCreator(DefaultListableBeanFactory beanFactory) {
